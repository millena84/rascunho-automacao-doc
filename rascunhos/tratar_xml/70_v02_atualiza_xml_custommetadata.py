...
CAMINHO_CSV = './3_saida_csv/1_listaCustomAlteracao.csv' PASTA_XML_ORIGEM = './2_entrada_xml' PASTA_XML_SAIDA = './4_xml_corrigido_regex'

def corrigir_regex(xml_path, canal, formato, destino): with open(xml_path, 'r', encoding='utf-8') as f: conteudo = f.read()
